...
describe("split_screen (§79)", function()
  ...
  it("guard suppresses injection for :Awiwi commands (D12)", function()
    eq("", awiwi._split_screen_result(":", "Awiwi journal", "h"))
    eq("", awiwi._split_screen_result(":", "Awiwi journal", "v"))
    eq("", awiwi._split_screen_result(":", "Aw journal", "h"))
    eq("", awiwi._split_screen_result(":", "Awiw journal", "v"))
  end)
